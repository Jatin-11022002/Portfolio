...
import mee from "../../../assets/campan.gif";
          ...
          <div className="md:w-1/2.5">
            ...
            <div className="inline-flex rounded-md shadow-sm">
              ...
              >
                <a
                  id
                  href="https://drive.google.com/file/d/1YjUfa2ogHHtSrnX0idhBRcFCXPSR2eT-/view?usp=sharing"
                  target="_blank"
                >
                  Check My CV
                </a>{" "}
              ...
              >
                <a
                  ...
                  target="_blank"
                >
                  LinkedIn <FaLinkedin className="inline-block ml-2" />
                </a>{" "}
              </button>{" "}
            </div>{" "}
